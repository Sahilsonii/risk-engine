    ...
    >
      ...
      <main className="ml-56 flex-1 p-6">
        ...
        {stats?.tenant_breakdown && stats.tenant_breakdown.length > 0 && (
          <div className="bg-white dark:bg-zinc-900/40 border border-zinc-200 dark:border-zinc-800 rounded-lg overflow-hidden mb-6 shadow-sm dark:shadow-none">
            <div className="px-4 py-3 border-b border-zinc-200 dark:border-zinc-800">
              <h2 className="text-xs font-semibold text-zinc-700 dark:text-zinc-300 uppercase tracking-wider">Tenant Breakdown</h2>
            </div>
              ...
              <table id="tenant-breakdown-table" className="w-full text-xs">
                ...
                <tbody className="divide-y divide-zinc-200/50 dark:divide-zinc-800/50">
                  {stats.tenant_breakdown.map((t) => (
                    ...
                    >
                      <td className="px-4 py-2 font-mono text-blue-600 dark:text-blue-400">{t.tenant_id}</td>
        ...
        {/* Filters + Table */}
        <div className="bg-white dark:bg-zinc-900/40 border border-zinc-200 dark:border-zinc-800 rounded-lg overflow-hidden shadow-sm dark:shadow-none">
          <div className="px-4 py-3 border-b border-zinc-200 dark:border-zinc-800 flex items-center gap-3">
            ...
            <select
              ...
              className="text-xs bg-zinc-50 border border-zinc-250 rounded px-2 py-1 text-zinc-800 focus:outline-none focus:border-blue-500 dark:bg-zinc-800 dark:border-zinc-700 dark:text-zinc-300"
            >
            ...
            {(tenantFilter || statusFilter) && (
              <button
                ...
                className="text-xs text-zinc-500 hover:text-red-500 dark:hover:text-red-400 ml-auto transition-colors"
              >
                Clear filters ×
              </button>
            )}
            {pagination && (
              <span className="text-xs text-zinc-400 dark:text-zinc-600 font-mono ml-auto">
